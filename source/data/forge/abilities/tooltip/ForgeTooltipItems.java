...
import static data.forge.abilities.conversion.support.ForgeTypes.CENTRIFUGE;
...
public class ForgeTooltipItems {
    ...
    public static void addCorruptedNanoforgeNote(TooltipMakerAPI tooltip) {
        ...
        int manufacturingCapacity = (int) Math.ceil(getForgingCapacityWithCR(fleet, MANUFACTURE));
        int assemblingCapacity = (int) Math.ceil(getForgingCapacityWithCR(fleet, ASSEMBLY));
    ...
    public static void addCatalyticCoreNote(TooltipMakerAPI tooltip) {
        ...
        int fleetCapacity = (int) Math.ceil(getForgingCapacityWithCR(fleet, REFINERY));
    ...
    public static void addSynchrotronCoreNote(TooltipMakerAPI tooltip) {
        ...
        int fleetCapacity = (int) Math.ceil(getForgingCapacityWithCR(fleet, CENTRIFUGE));
