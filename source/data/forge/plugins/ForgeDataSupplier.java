...
public class ForgeDataSupplier {
    ...
    public static void loadSettings(String fileName) throws IOException, JSONException {
            ...
            ForgeSettings.ENABLE_CARGO_REQUIREMENT = settings.getBoolean("forge_enable_cargo_requirement");
            ForgeSettings.ENABLE_CIVGRADE_REQUIREMENT = settings.getBoolean("forge_enable_civgrade_requirement");

            // Here: Miscellaneous Settings
            ForgeSettings.ENABLE_SLOW_MOVE_PENALTY = settings.getBoolean("forge_enable_slow_move_penalty");
            ForgeSettings.ENABLE_DETECT_AT_RANGE_PENALTY = settings.getBoolean("forge_enable_sensor_penalty");

            ForgeSettings.ENABLE_BURN_ABILITIES_INCOMPATIBILITY = settings.getBoolean("forge_enable_burn_abilities_incompatibility");
            ...
            ForgeSettings.INVERTED_GRID_NOTIFICATION = settings.getBoolean("forge_inverted_grid_notification");
